...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <?php
          ...
          <?php
          $languages = ['Английский' => 100, 'Испанский' => 50, 'Немецкий' => 10]
          ?>
          ...
          <?php foreach($languages as $langName => $langValue): ?>
            ...
            <div class="w3-light-grey w3-round-xlarge">
              <div class="w3-round-xlarge w3-teal"
                style="height:24px;width:<?php echo $langValue;?>%">
              </div>
            </div>
          <?php endforeach; ?>
          <br>
    ...
    <?php
      $work = [
        'occupation' => ['Front End Developer', 'Web Developer / something.com', 'Graphic Designer / designsomething.com'],
        'dates' => ['Jan 2015 - Current', 'Mar 2012 - Dec 2014', 'Jun 2010 - Mar 2012'],
    ...
    ?>
      ...
      <?php while ($ind < 3):?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $work['occupation'][$ind];?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work['dates'][$ind];?></h6>
          <p><?php echo $work['description'][$ind];?></p>
          <?php $ind ++;?>
          <hr>
          </div>
          <?php endwhile;?>
